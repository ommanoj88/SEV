...
const ArchitectureFlowInner: React.FC = () => {
  ...
  console.log('ArchitectureFlow - Total nodes:', transformedNodes.length);
  console.log('ArchitectureFlow - First node:', transformedNodes[0]);
