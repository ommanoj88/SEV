...
|---------|--------|-------|
| Document entity | VERIFIED | Document.java exists |
| Document service | VERIFIED | DocumentService.java implemented |
| File storage | VERIFIED | FileStorageService.java exists |
| Document controller | VERIFIED | All REST endpoints work |
| Upload/Download | VERIFIED | Multipart file handling works |
| Verification workflow | VERIFIED | verify/reject endpoints exist |
