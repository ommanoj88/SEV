...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@Valid @RequestBody LoginRequest request) {
        log.info("POST /api/v1/auth/login - Login attempt for Firebase UID: {}", request.getFirebaseUid());
    ...
    public ResponseEntity<UserResponse> getUserById(
        ...
        log.info("GET /api/v1/auth/users/{} - Fetching user by ID", id);
    ...
    public ResponseEntity<List<UserResponse>> getAllUsers() {
        log.info("GET /api/v1/auth/users - Fetching all users");
    ...
    public ResponseEntity<UserResponse> updateUser(
        ...
        log.info("PUT /api/v1/auth/users/{} - Updating user", id);
    ...
    public ResponseEntity<Void> deleteUser(
            @Parameter(description = "User ID", required = true)
            @PathVariable Long id) {
        log.info("DELETE /api/v1/auth/users/{} - Deleting user", id);
    ...
    public ResponseEntity<List<UserResponse>> getUsersByCompany(
        ...
        log.info("GET /api/v1/auth/users/company/{} - Fetching users by company", companyId);
    ...
    public ResponseEntity<UserResponse> getUserByFirebaseUid(
        ...
        log.info("GET /api/v1/auth/users/firebase/{} - Fetching user by Firebase UID", firebaseUid);
     ...
     * Cached for 5 minutes to prevent infinite loops and reduce DB load
     */
    @GetMapping("/me")
    @Operation(
    ...
    public ResponseEntity<UserResponse> getCurrentUser(
        ...
        log.debug("GET /api/v1/auth/me - Getting current user from Authorization header");
        ...
        try {
            ...
            log.debug("Verified Firebase token for UID: {}", firebaseUid);

            UserResponse user = userService.getUserByFirebaseUid(firebaseUid);

            // Add caching headers to prevent infinite frontend loops
    ...
    public ResponseEntity<AuthResponse> syncUser(@Valid @RequestBody RegisterRequest request) {
        log.info("POST /api/v1/auth/sync - Syncing user: {}", request.getEmail());
